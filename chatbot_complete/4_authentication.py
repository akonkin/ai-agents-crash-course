...
from nutrition_agent_multi import nutrition_agent, exa_search_mcp
...
async def on_message(message: cl.Message):
    ...
    try:
        ...
        # Обработка случая, когда guardrail сработал
        await cl.Message(
            content="Sorry, I can only answer questions about food and nutrition. Please ask me something related to food, calories, or nutrition."
        ).send()
